...
class IdMapperTest {
    ...
    fun shouldMapIdFromTypeUrl() {
        val url = "test/type/3/"
        assertEquals(3, IdMapper.fromTypeUrl(url))
    }
    ...
    fun shouldMapIdFromTypeUrl_returns0IfNotCorrectUrl() {
        val url = "test/3"
        assertEquals(0, IdMapper.fromTypeUrl(url))
    }

    @Test
    fun shouldMapIdFromPokemonUrl() {
        val url = "test/pokemon/2/"
        assertEquals(2, IdMapper.fromPokemonUrl(url))
    }
    ...
    fun shouldMapIdFromPokemonUrl_returns0IfNotCorrectUrl() {
        val url = "test/2"
        assertEquals(0, IdMapper.fromPokemonUrl(url))
    }
}